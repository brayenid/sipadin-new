            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-4 space-y-3 shadow-2xs">
              ...
              <div className="p-3 bg-indigo-50/70 border border-indigo-200/80 rounded-xl text-xs sm:text-[13px] text-slate-700 leading-relaxed flex items-start gap-2.5 shadow-2xs">
                ...
                <div>
                  ...
                  <p>
                    Sistem ini dibangun oleh Tim Pelayanan Publik dan Tata Laksana Bagian Organisasi guna merespons <strong>kebutuhan kedinasan yang mendesak</strong> secara cepat <strong className="text-slate-900 font-bold underline decoration-indigo-300">tanpa menggunakan anggaran</strong> serta akan terus dikembangkan dan disesuaikan dengan kebutuhan pengguna. Jika terdapat usulan, kebutuhan sistem lainnya, maupun kritik dan saran, dapat disampaikan langsung kepada Tim Pelayanan Publik dan Tata Laksana Bagian Organisasi Setdakab Kutai Barat.
                  </p>
                </div>
              </div>
            </div>
