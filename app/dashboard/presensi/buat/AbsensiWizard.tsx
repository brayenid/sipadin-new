  ...
  const handleSubmitFinal = async () => {
    ...
    try {
      const created = await createAgendaAbsensi({
        ...
        recurringWeeks: form.recurringWeeks,
                ...
                <div className="p-4 bg-indigo-50/70 border border-indigo-100 rounded-2xl space-y-4 mt-2 animate-in fade-in-50 duration-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
                    <div className="space-y-1.5">
                      ...
                      >
                        <SelectTrigger className="bg-white text-xs h-9 border-indigo-200 shadow-2xs">
                  ...
                  <div className="p-3.5 bg-white/95 rounded-xl border border-indigo-100 space-y-2.5 shadow-2xs">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap pt-0.5">
                      ...
                      {[1, 2, 3, 4, 5].map((wk) => {
                        const isWkChecked = form.recurringWeeks.includes(wk);
                        return (
                          <button
                            key={wk}
                            type="button"
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <Input
                            ...
                            className="text-xs bg-white h-8 font-semibold border-slate-300 mt-0.5"
                          />
                        </div>
                        <div>
                  ...
                  <p className="text-[11px] text-indigo-800/90 leading-relaxed bg-indigo-100/60 p-2.5 rounded-lg border border-indigo-200/60">
