...
import { refineLaporanFieldAi } from "@/app/actions/ai-laporan";
import { toast } from "sonner";

export default function RefineLaporanFieldAiButton({
  fieldName,
  fieldLabel,
  currentDoc,
  aiInitData,
  ...
  fieldName: "hasilPembuka" | "hasilPoin" | "hasilNarasi";
  fieldLabel: string;
  currentDoc: {
    kegiatan: string;
    waktu: string;
  ...
  const handleRefine = async () => {
    ...
    setLoading(true);
    try {
      const result = await refineLaporanFieldAi({
        ...
        <PopoverContent className="w-[280px] sm:w-[320px] p-3 text-xs space-y-2.5" align="end">
          ...
          <div className="space-y-1">
            <Input
              ...
              placeholder="Instruksi khusus (misal: buat lebih ringkas / tambah detail)..."
