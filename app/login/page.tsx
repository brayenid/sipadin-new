    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary text-primary-foreground shadow-sm mb-4">
            <ShieldCheck className="w-8 h-8" />
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">SIPADIN</h1>
          <p className="text-slate-500 text-sm mt-1">Sistem Pencatatan SPJ Elektronik v2</p>
          <p className="text-slate-400 text-xs mt-1">Sekretariat Daerah Kabupaten Kutai Barat</p>
        </div>
